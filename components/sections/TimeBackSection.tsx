      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">
            How to <span className="gradient-text-animated">ACTUALLY</span> Get Your Time Back Without Hiring More People
          </h2>
        </motion.div>

        {/* Main Content Card */}
        <div className="glass-card glass-card-hover rounded-3xl p-8 lg:p-12 light-beam relative">
          <div className="space-y-8">
            ...
            <div className="bg-gray-800/30 rounded-2xl p-6 lg:p-8 border border-gray-700/50">
              <p className="text-lg lg:text-xl text-gray-300 leading-relaxed mb-4">
                ...
                <span className="gradient-text-animated font-semibold">5-15 hours you&apos;ll never get back</span>.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="pl-8">
                <p className="text-2xl sm:text-3xl lg:text-4xl font-bold gradient-text-animated mb-6">
